...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001556123446').split()]
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Movietube")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Channel Button Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+XHtUZ6W6co0wM2M1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+tXsFTyrd27ZiZDA1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/movietube_support')
